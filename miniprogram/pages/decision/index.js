...
Page({
  data: {
    themes: [
      { id: 'food', title: '今天吃什么', options: ['火锅', '烧烤', '日料', '麻辣烫', '轻食', '自己做', '牛肉面', '披萨', '汉堡', '川菜', '粤菜', '米线'] },
      { id: 'play', title: '周末去哪玩', options: ['看电影', '逛公园', '游乐园', '宅家', '博物馆', '爬山', '逛街', '书店', '密室', '看展'] },
      { id: 'housework', title: '谁做家务', options: ['我做', 'TA做', '一起做', '掷骰子', '点外卖', '扫地机器人', '石头剪刀布'] },
      { id: 'drink', title: '喝点什么', options: ['奶茶', '咖啡', '果汁', '快乐水', '白开水', '酸奶', '气泡水'] },
      { id: 'truth', title: '真心话', options: ['初印象', '最喜欢TA哪点', '想一起做的事', '最感动的瞬间', '尴尬糗事'] }
    ],
    currentTab: 0,
    cards: [],
    isShuffling: false,
  ...
  onShareAppMessage: function() {
    return {
      title: this.data.finalResult ? `✨ 命运指引我们去：${this.data.finalResult}` : '🔮 快来开启我们的命运抉择！',
