...
DEFAULT_CAPSULE_LIMIT	10	限制时光胶囊的存储槽位，未来可做成付费扩容点。
QUESTIONS_PER_ROUND	10	控制“默契大闯关”一局有多少道题。
WATER_COST	10	每次点击“浇水”扣除的爱意值。
WATER_GROWTH	10	每次浇水玫瑰增加的进度值。
HARVEST_MIN_GROWTH	300	玫瑰生长到多少数值变成“成熟”状态（Lv.4），可以收获。
CHECKIN_REWARD	50	每日拍照并保存到时光轴后，奖励的爱意值。